...
| 2026-06-27 | V1 = faithful digital editions (Level A) of **pre-1929 public-domain** books, plus catalog + metadata search (ADR-0004). | Decided | Adam confirmed pre-1929 scope; faithful re-rendering, not reinterpretation. | If rights review leaves too few pre-1929 books. |
