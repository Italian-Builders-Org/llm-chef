...
- The first-root reconciliation merged `Kochrezepte fur den Unterricht im Kochen` with the local `RICETTARIO AUSTROUNGARICO 1912 (SACHER)` source alias. Later 2026-06-28 updates brought the working inventory to 30 rows; see `BOOK_LIST_SEED.md`.
